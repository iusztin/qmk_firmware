 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | GUI  |ADJUST| F12  | Alt  |Lower |Space | Bksp |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_ortho_4x12(
   ...
   KC_LGUI,ADJUST,    KC_F12,  KC_LALT, LOWER,   KC_SPC,  KC_BSPC, RAISE,   KC_LEFT, KC_DOWN, KC_UP,    KC_RGHT
),
...
[_RAISE] = LAYOUT_ortho_4x12(
  ...
  KC_LCTL, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_UNDS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
  KC_LGUI, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
...
[_ADJUST] =  LAYOUT_ortho_4x12(
  KC_ESC , _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, QK_BOOT,
